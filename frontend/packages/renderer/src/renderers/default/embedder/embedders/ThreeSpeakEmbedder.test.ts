    ...
    describe('processEmbed', () => {
        it('should generate correct iframe HTML', () => {
            ...
            expect(result).to.equal(
                '<div class="videoWrapper"><iframe width="500" height="300" src="https://play.3speak.tv/embed?v=username/video-id&mode=iframe&layout=desktop" frameborder="0" allowfullscreen></iframe></div>'
            );
        });
    });
});
