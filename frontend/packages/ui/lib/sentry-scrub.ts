...
// The optional leading `P` also catches Hive MASTER PASSWORDS, which are
// conventionally `'P' + WIF` (e.g. P5J...). A thrown error/breadcrumb containing a
// freshly generated master password (lite -> full account upgrade, spec §F.3) must
// be redacted too — the account's owner key is derived from it.
const WIF_PATTERN = /P?5[HJK][1-9A-HJ-NP-Za-km-z]{49,50}/g;
