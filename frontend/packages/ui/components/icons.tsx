// Functional UI icons now come from the house-drawn "Rhombus line" set (./custom-icons).
// Only the LucideProps/Icon types and the three social brand glyphs remain from lucide.
import { LucideProps, type Icon as LucideIcon, Twitter, Youtube, Instagram } from 'lucide-react';
import * as CI from './custom-icons';
...
export const Icons = {
  ...
  bold: CI.bold,
  italic: CI.italic,
  strikethrough: CI.strikethrough,
  heading: CI.heading,
  code: CI.code,
  ...
  arrowDownCircle: CI.arrowDownCircle,
  chevronDown: CI.chevronDown,
  chevronUp: CI.chevronUp,
  star: CI.star,
  dollar: CI.dollar,
  circle: CI.circle,
  ...
  twitter: Twitter,
  youtube: Youtube,
  calendarHeart: CI.calendarHeart,
  mapPin: CI.mapPin,
  globe2: CI.globe2,
  instagram: Instagram,
  userPlus: CI.userPlus,
  trash: CI.trash,
  atSign: CI.atSign,
  ...
  google: (props: LucideProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="87.3" height="78" viewBox="0 0 87.3 78" {...props}>
      <path
  ...
  peakvault: (props: LucideProps) => (
    <svg
      ...
      width="80"
      height="80"
      viewBox="0 0 251.19255 251.18987"
      {...props}
    >
      <defs>
        <linearGradient id="linearGradient867">
          <stop style={{ stopColor: '#3730a3', stopOpacity: 1 }} offset="0" id="stop863" />
          <stop style={{ stopColor: '#e11d48', stopOpacity: 1 }} offset="1" id="stop865" />
        </linearGradient>
        <linearGradient
  ...
  messageSquareText: CI.messageSquareText
};
