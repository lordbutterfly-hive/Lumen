...
check('valid play.3speak.tv embed -> rebuilt play.3speak.tv host', threeSpeakEmbedUrl('https://play.3speak.tv/embed?v=badadib/g9sgdk5h') === 'https://play.3speak.tv/embed?v=badadib/g9sgdk5h');
check('valid 3speak.tv watch -> embed', threeSpeakEmbedUrl('https://3speak.tv/watch?v=user/perm-link') === 'https://play.3speak.tv/embed?v=user/perm-link');
check('valid 3speak.online', threeSpeakEmbedUrl('https://3speak.online/embed?v=a1/b2') === 'https://play.3speak.tv/embed?v=a1/b2');
...
check('injects the player when metadata is 3speak and body lacks it', bodyWithThreeSpeakPlayer('just text', meta3).startsWith('https://play.3speak.tv/embed?v=badadib/g9sgdk5h\n\n'));
