  ...
  return (
    <div className="mx-auto flex flex-col items-center py-8">
      ...
      <div className="text-md py-2">
        ...
        <Link href="/" className="text-ink-info-9 hover:cursor-pointer">
          {t('four_oh_four.our_homepage')}
        </Link>
      </div>
      <div className="flex gap-2 py-2">
        <Link href="/created" className="text-ink-info-9 hover:cursor-pointer">
          {t('four_oh_four.new_posts')}
        </Link>
        <Link href="/hot" className="text-ink-info-9 hover:cursor-pointer">
          {t('four_oh_four.hot_posts')}
        </Link>
        <Link href="/trending" className="text-ink-info-9 hover:cursor-pointer">
          {t('four_oh_four.trending_posts')}
        </Link>
        <Link href="/muted" className="text-ink-info-9 hover:cursor-pointer">
