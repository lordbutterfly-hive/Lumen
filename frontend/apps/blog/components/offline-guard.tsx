        ...
        >
          {offline ? (
            <div
              ...
              className="flex items-center gap-2 rounded-full border border-[#eee2dc] bg-[#161511] px-4 py-2 font-sans text-[13px] text-white shadow-[0_2px_8px_rgba(20,18,10,0.25)]"
            >
