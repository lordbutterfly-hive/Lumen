    ...
    >
      {nsfw === 'hide' ? null : (
        <Card
          ...
          className="mb-4 rounded-panel border border-line-9 bg-surface-1 px-[22px] py-[22px] text-primary shadow-[0_1px_2px_rgba(26,22,18,0.035),0_3px_12px_-6px_rgba(70,46,30,0.13)] transition-colors hover:bg-surface-3"
        >
          {post.original_entry ? (
