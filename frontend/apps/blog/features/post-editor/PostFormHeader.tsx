...
// control only.
const TOGGLE_CLASS =
  "inline-flex items-center gap-1.5 rounded-card border border-[#ebebeb] bg-white px-3 py-1.5 text-caption font-medium text-[#6b7280] transition-colors hover:border-line-brand-10 hover:text-ink-brand-6 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-line-brand-10/40";
