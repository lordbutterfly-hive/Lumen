...
function SearchSortSelect({ query }: { query: string }) {
  ...
  return (
    <div className="flex shrink-0 items-center gap-2">
      <label htmlFor="search-sort" className="font-sans text-caption text-ink-10">
      ...
      <div className="relative">
        <select
          ...
          className="h-9 appearance-none rounded-card border border-line-9 bg-surface-1 py-0 pl-3 pr-8 font-sans text-caption text-ink-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-line-brand-10/30"
        >
