 ...
 * for the same reason `page-masthead.tsx`, `right-rail.tsx` and
 * `account-settings/lib/card.ts` already use hex literals: the warm Lumen
 * surface palette (`#ffffff` / `#fbf7f2`, hairlines `#ebebeb` / `#eee2dc`,
 * accent `#c0392b`) is not the same palette as the legacy `bg-background-*` /
 * `text-destructive` theme tokens, and it was exactly those legacy tokens that
...
export const FOLLOW_BUTTON_PRIMARY =
  'inline-flex h-9 shrink-0 items-center justify-center rounded-[12px] bg-[#c0392b] px-4 font-sans text-[13px] leading-[20px] font-semibold text-white transition-colors hover:bg-[#a93226] disabled:pointer-events-none disabled:opacity-60';

/** Following (already following): quiet outline that turns red on hover. */
export const FOLLOW_BUTTON_OUTLINE =
  'group inline-flex h-9 shrink-0 items-center justify-center rounded-[12px] border border-[#e4e6e9] bg-transparent px-4 font-sans text-[13px] leading-[20px] font-semibold text-[#3f4650] transition-colors hover:border-[#c0392b] hover:text-[#c0392b] disabled:pointer-events-none disabled:opacity-60';
...
export const PAGER_BUTTON =
  'inline-flex h-9 items-center justify-center rounded-[12px] border border-[#e4e6e9] bg-white px-4 font-sans text-[13px] leading-[20px] font-semibold text-[#3f4650] transition-colors hover:border-[#c0392b] hover:text-[#c0392b] disabled:pointer-events-none disabled:border-[#f0f0f0] disabled:text-[#c7cbd1]';

/** The toolbar search field. */
export const SEARCH_INPUT =
  'h-9 w-full rounded-[12px] border border-[#ebebeb] bg-white pl-9 pr-3 font-sans text-[13px] leading-[20px] text-[#161511] outline-none transition-colors placeholder:text-[#9ca3af] focus:border-[#c0392b]';
