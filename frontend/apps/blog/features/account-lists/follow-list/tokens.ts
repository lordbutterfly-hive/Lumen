...
export const FOLLOW_BUTTON_PRIMARY =
  'inline-flex h-9 shrink-0 items-center justify-center rounded-control bg-surface-brand-12 px-4 font-sans text-caption font-semibold text-white transition-colors hover:bg-[#a93226] disabled:pointer-events-none disabled:opacity-60';

/** Following (already following): quiet outline that turns red on hover. */
export const FOLLOW_BUTTON_OUTLINE =
  'group inline-flex h-9 shrink-0 items-center justify-center rounded-control border border-[#e4e6e9] bg-transparent px-4 font-sans text-caption font-semibold text-[#3f4650] transition-colors hover:border-line-brand-10 hover:text-ink-brand-6 disabled:pointer-events-none disabled:opacity-60';
...
export const PAGER_BUTTON =
  'inline-flex h-9 items-center justify-center rounded-control border border-[#e4e6e9] bg-white px-4 font-sans text-caption font-semibold text-[#3f4650] transition-colors hover:border-line-brand-10 hover:text-ink-brand-6 disabled:pointer-events-none disabled:border-[#f0f0f0] disabled:text-ink-21';
