...
//
// ★ EXPORTED, because the Meritum coin stamps THIS SAME PATH into its exergue
// (`meritum/coin/meritum-coin.tsx`, placed by `meritum/coin/geometry.ts`). One
// trace, one source: a second copy of 4kB of generated curve data is a copy that
// can drift, and the moment it drifts the coin stops carrying the same mark as
// the nav. The coin re-colours it with its own metal ramp rather than
// `currentColor`, which is a fill choice at the call site, not a second asset.
export const CREATOR_TOKEN_LAUREL_PATH =
