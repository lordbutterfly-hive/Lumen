  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-1.5">
        <label className="text-[13px] leading-[20px] font-semibold text-ink-7">{t('wallet.dialogs.common.amount')}</label>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="flex flex-col gap-1.5">
          <label className="text-[13px] leading-[20px] font-semibold text-ink-7">
