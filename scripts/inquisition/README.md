...
|---|---|---|
| `warm-inquisition.sh` | `/opt/lumen/warm-inquisition.sh` | Warms the five boards, then every record on the list, three at a time |
...
records in flight (default 3), `FRESH_DAYS` (6), `ACTIVE_DAYS` (30), `WHALE_MIN_HP` (100000).
